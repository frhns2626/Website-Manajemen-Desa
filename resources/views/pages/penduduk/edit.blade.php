            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required>{{ old('alamat', $penduduk->alamat) }}</textarea>
                        @error('alamat')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="pekerjaan" id="pekerjaan"
                            ...
                            <option value="Belum/Tidak Bekerja"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Belum/Tidak Bekerja' ? 'selected' : '' }}>
                                Belum/Tidak Bekerja</option>
                            <option value="Pelajar/Mahasiswa"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Pelajar/Mahasiswa' ? 'selected' : '' }}>
                                Pelajar/Mahasiswa</option>
                            <option value="Mengurus Rumah Tangga"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Mengurus Rumah Tangga' ? 'selected' : '' }}>
                                Mengurus Rumah Tangga</option>
                            <option value="Pegawai Negeri Sipil (PNS)"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Pegawai Negeri Sipil (PNS)' ? 'selected' : '' }}>
                                Pegawai Negeri Sipil (PNS)</option>
                            <option value="TNI"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'TNI' ? 'selected' : '' }}>
                                TNI</option>
                            <option value="Polri"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Polri' ? 'selected' : '' }}>
                                Polri</option>
                            <option value="Karyawan Swasta"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Karyawan Swasta' ? 'selected' : '' }}>
                                Karyawan Swasta</option>
                            <option value="Karyawan BUMN"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Karyawan BUMN' ? 'selected' : '' }}>
                                Karyawan BUMN</option>
                            <option value="Petani/Pekebun"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Petani/Pekebun' ? 'selected' : '' }}>
                                Petani/Pekebun</option>
                            <option value="Pedagang"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Pedagang' ? 'selected' : '' }}>
                                Pedagang</option>
                            <option
                                value="Nelayan" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Nelayan' ? 'selected' : '' }}>
                                Nelayan</option>
                            <option value="Wiraswasta"
                                {{ old('pekerjaan', $penduduk->pekerjaan) == 'Belum/Tidak Bekerja' ? 'selected' : '' }}>
                                Wiraswasta</option>
                            <option
                                value="Guru" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Guru' ? 'selected' : '' }}>
                                Guru</option>
                            <option
                                value="Dosen" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Dosen' ? 'selected' : '' }}>
                                Dosen</option>
                            <option
                                value="Dokter" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Dokter' ? 'selected' : '' }}>
                                Dokter</option>
                            <option
                                value="Perawat" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Perawat' ? 'selected' : '' }}>
                                Perawat</option>
                            <option
                                value="Sopir" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Sopir' ? 'selected' : '' }}>
                                Sopir</option>
                            <option
                                value="Buruh Harian Lepas" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Buruh Harian Lepas' ? 'selected' : '' }}>
                                Buruh Harian Lepas</option>
                            <option
                                value="Tukang Bangunan" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Tukang Bangunan' ? 'selected' : '' }}>
                                Tukang Bangunan</option>
                            <option
                                value="Pensiunan" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Pensiunan' ? 'selected' : '' }}>
                                Pensiunan</option>
                            <option
                                value="Lainnya" {{ old('pekerjaan', $penduduk->pekerjaan) == 'Lainnya' ? 'selected' : '' }}>
                                Lainnya</option>
                        </select>
                        @error('pekerjaan')
                        <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="pendidikan" id="pendidikan"
                            ...
                            <option value="SD / MI"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'SD / MI' ? 'selected' : '' }}>SD / MI
                            </option>
                            <option value="SMP / SLTP Sederajat"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'SMP / SLTP Sederajat' ? 'selected' : '' }}>
                                SMP /
                                SLTP Sederajat</option>
                            <option value="SMA / SLTA Sederajat"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'SMA / SLTA Sederajat' ? 'selected' : '' }}>
                                SMA /
                                SLTA Sederajat</option>
                            <option value="D1"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'D1' ? 'selected' : '' }}>Diploma I
                                (D1)</option>
                            <option value="D2"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'D2' ? 'selected' : '' }}>Diploma
                                II (D2)</option>
                            <option value="D3"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'D3' ? 'selected' : '' }}>Diploma
                                III (D3)</option>
                            <option value="D4 / S1"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'D4 / S1' ? 'selected' : '' }}>Sarjana
                                (D4 / S1)</option>
                            <option value="S2"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'S2' ? 'selected' : '' }}>Magister
                                (S2)</option>
                            <option value="S3"
                                {{ old('pendidikan', $penduduk->pendidikan) == 'S3' ? 'selected' : '' }}>Doktor
                                (S3)</option>
                        </select>
                        @error('pendidikan')
                        <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="status_tinggal" id="status_tinggal"
                            ...
                            <option value="">-- Pilih --</option>
                            <option value="tetap"
                                {{ old('status_tinggal', $penduduk->status_tinggal) == 'tetap' ? 'selected' : '' }}>
                                Tetap
                            </option>
                            <option value="pendatang"
                                {{ old('status_tinggal', $penduduk->status_tinggal) == 'pendatang' ? 'selected' : '' }}>
                                Pendatang</option>
                            <option value="pindah"
                                {{ old('status_tinggal', $penduduk->status_tinggal) == 'pindah' ? 'selected' : '' }}>
                                Pindah
                            </option>
                            <option value="meninggal"
                                {{ old('status_tinggal', $penduduk->status_tinggal) == 'meninggal' ? 'selected' : '' }}>
                                Meninggal</option>
                        </select>
